...
The live-log endpoint `http://192.168.1.23:8765/` was retried again on 2026-05-11 HKT after tightening evidence archive verification and failed with `curl: (28) Connection timed out after 8010 milliseconds`, so live evidence remains blocked on endpoint availability.
