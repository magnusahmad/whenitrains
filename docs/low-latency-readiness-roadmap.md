...
The live-log endpoint `http://192.168.1.23:8765/` was retried again on 2026-05-11 HKT after the drift-archive smoke check. Both the sandboxed request and the approved LAN retry timed out after 8 seconds, so live evidence remains blocked on endpoint availability.
