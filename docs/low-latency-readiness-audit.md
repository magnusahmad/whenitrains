...
- `low-latency-verify-evidence-archive --input-dir ...` verifies the manifest, required report files, recorded SHA-256 checksums, and `all_gates_passed=True`, and fails with the archived missing-gate list for incomplete evidence bundles.
