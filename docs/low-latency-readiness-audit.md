...
The live log endpoint at `http://192.168.1.23:8765/` was retried again on 2026-05-11 HKT and failed with `curl: (28) Connection timed out after 8003 milliseconds`.
