...
The live log endpoint at `http://192.168.1.23:8765/` was retried again on 2026-05-11 HKT and failed with `curl: (7) Failed to connect to 192.168.1.23 port 8765 after 0 ms: Couldn't connect to server`.
